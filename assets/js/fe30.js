function setval(){
  ...
  var d = document.getElementById("input-ba").value;
  var d2 = document.getElementById("input-ba2").value;
  var d3 = document.getElementById("input-ba3").value;
  var d4 = document.getElementById("input-ba4").value;
